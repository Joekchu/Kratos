...
KratosFluidDynamicsApplication::KratosFluidDynamicsApplication():
    ...
    mEmbeddedWeaklyCompressibleNavierStokesDiscontinuousEdge2D3N(0, Element::GeometryType::Pointer(new Triangle2D3<Node<3> >(Element::GeometryType::PointsArrayType(3)))),
    mEmbeddedWeaklyCompressibleNavierStokesDiscontinuousEdge3D4N(0, Element::GeometryType::Pointer(new Tetrahedra3D4<Node<3> >(Element::GeometryType::PointsArrayType(4)))),
    ...
    mEmbeddedQSVMSDiscontinuousEdge2D3N(0, Element::GeometryType::Pointer(new Triangle2D3<Node<3> >(Element::GeometryType::PointsArrayType(3)))),
    mEmbeddedQSVMSDiscontinuousEdge3D4N(0, Element::GeometryType::Pointer(new Tetrahedra3D4<Node<3> >(Element::GeometryType::PointsArrayType(4)))),
...
void KratosFluidDynamicsApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(P_GRAD_PENALTY_CONSTANT)
    KRATOS_REGISTER_VARIABLE(V_GRAD_PENALTY_CONSTANT)
    ...
    KRATOS_REGISTER_ELEMENT("EmbeddedWeaklyCompressibleNavierStokesDiscontinuousEdge2D3N",mEmbeddedWeaklyCompressibleNavierStokesDiscontinuousEdge2D3N);
    KRATOS_REGISTER_ELEMENT("EmbeddedWeaklyCompressibleNavierStokesDiscontinuousEdge3D4N",mEmbeddedWeaklyCompressibleNavierStokesDiscontinuousEdge3D4N);
    ...
    KRATOS_REGISTER_ELEMENT("EmbeddedQSVMSDiscontinuousEdge2D3N",mEmbeddedQSVMSDiscontinuousEdge2D3N);
    KRATOS_REGISTER_ELEMENT("EmbeddedQSVMSDiscontinuousEdge3D4N",mEmbeddedQSVMSDiscontinuousEdge3D4N);
