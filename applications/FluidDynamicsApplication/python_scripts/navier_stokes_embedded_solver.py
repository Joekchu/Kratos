...
class EmbeddedFormulation(object):
    ...
    def __init__(self, formulation_settings):
        ...
        if formulation_settings.Has("element_type"):
            ...
            if element_type == "embedded_navier_stokes":
                ...
                self._SetUpEmbeddedWeaklyCompressibleNavierStokesDiscontinuous(formulation_settings)
            elif element_type == "embedded_weakly_compressible_navier_stokes_discontinuous_edge":
    ...
    def _SetUpEmbeddedWeaklyCompressibleNavierStokesDiscontinuousEdge(self, formulation_settings):
        default_settings = KratosMultiphysics.Parameters(r"""{
            "element_type": "embedded_weakly_compressible_navier_stokes_discontinuous_edge",
            "is_slip": true,
            "slip_length": 1.0e8,
            "penalty_coefficient": 10.0,
        ...
        self.element_name = "EmbeddedWeaklyCompressibleNavierStokesDiscontinuousEdge"
        self.condition_name = "NavierStokesWallCondition"
        self.level_set_type = formulation_settings["level_set_type"].GetString()
        self.element_integrates_in_time = True
        self.element_has_nodal_properties = True
